	                    ...
	                    <div class="panel panel-primary">
	                        ...
	                        <div class="panel-body">
	                            <form>
	                                ...
	                                <div class="form-group">
	                                    <a href="check-info-for-extra-curr.html" class="btn button button-green" role="button"><i class="fa fa-backward back-icon" aria-hidden="true"></i>Back</a>
	                                    <a href="list-of-extra-curr.html" class="btn btn-success button" role="button">Next<i class="fa fa-forward next-icon" aria-hidden="true"></i></a>
