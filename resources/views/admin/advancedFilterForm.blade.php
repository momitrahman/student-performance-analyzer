                ...
                <div class="panel-body">
                    ...
                    <form action={{ route( "showFilterResult") }} method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <input type="hidden" name="class[]" value="all"> @elseif ($class === "single")
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="year" class="col-md-2">Year</label> @if ($year === "all")
                                    <input type="hidden" name="year[]" value="all">
                                    <label for="year" class="col-md-10" style="font-weight:bold">All</label> @elseif ($year === "single" )
                                    <!--Single year  -->
                                    <div class="col-md-10">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="mark" class="col-md-2">Marks</label> @if ($mark === "all")
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <!-- Maximum -->
                                    @else
                                    <input type="text" class="form-control" name="output_limit" placeholder="Maximum Limit."> @endif
                                    <!-- Maximum  -->
                                </div>
                            </div>
                        </div>
